...
export const CallToActionSection: React.FC = () => {
  return (
    <section className="relative py-48 mt-20">
      ...
      {/* <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1595192092799-c87abfef9f41')] bg-cover bg-center opacity-50"></div> */}
      <div className="absolute inset-0 bg-linear-to-t from-black via-black/50 to-transparent"></div>
      <div className="absolute inset-0 bg-linear-to-b from-black via-transparent to-transparent"></div>

      <div className="relative z-10 max-w-4xl px-6 mx-auto text-center">
        {/* <h2 className="mb-8 text-5xl font-medium text-white md:text-7xl">
          Built For GCCs
        </h2> */}
        <h3 className="mb-8 text-4xl font-medium text-white md:text-7xl">
          Hire with Intelligence. Not Guesswork.
        </h3>
        <p className="mb-16 text-2xl text-zinc-300">
          We work with teams where false positives are expensive and quality
