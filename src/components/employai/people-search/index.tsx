...
import PeopleSearchDashboard from "./PeopleSearchDashboard";
...
const PeopleSearchSection: React.FC = () => {
  return (
    <section
      id="people-search"
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-8 md:px-12 lg:px-16 xl:px-24 relative z-10">
        <div className="flex flex-col gap-4 sm:gap-5 md:gap-6 text-left items-start max-w-4xl">
          <SectionHeading
            heading="Search Beyond Human Capability"
            badgeText="AI-Native People Search"
            badgeStyle="#2563eb"
          />
          <p className="text-base sm:text-lg md:text-xl leading-normal text-zinc-400 max-w-full sm:max-w-xl">
            <span className="text-white font-medium">
              Employ's people search is not resume retrieval.
            </span>{" "}
            It models human capability patterns across candidates and identifies
            relevance that humans cannot compute manually.
          </p>
        </div>
      </div>

      {/* Desktop Dashboard Illustration here */}
