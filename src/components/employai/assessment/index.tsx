...
import { CandidateRadar } from "../../MockupCharts";
    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-8 md:px-12 lg:px-16 xl:px-24 relative z-10">
        <div className="flex flex-col gap-4 sm:gap-5 md:gap-6 text-left items-start max-w-4xl">
          <SectionHeading
            heading="Decision-Ready Assessment"
            badgeText="How We Assess Candidates"
            badgeStyle="#16a34a"
          />
          <p className="text-base sm:text-lg md:text-xl leading-normal text-zinc-400 max-w-full sm:max-w-xl">
            <span className="text-white font-medium">
              Every candidate is evaluated using a structured human
              representation model.
            </span>{" "}
            We measure capability depth, competency patterns, and signal
            confidence — visualized and summarized for rapid decisions.
          </p>
        </div>
      </div>
