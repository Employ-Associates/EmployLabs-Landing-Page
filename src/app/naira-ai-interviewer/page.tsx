...
export const metadata: Metadata = {
  title: "Naira — AI Interviewer for Every Role | EmployLabs",
  description:
    "Meet Naira, the AI interview agent by EmployLabs. One assessment agent for engineering, sales, product, HR, finance, legal, and more. No question banks — fresh artifacts, calibrated to every role. Powered by Signal Interview™.",
  keywords: [
    "AI interviewer",
    "AI interview agent",
